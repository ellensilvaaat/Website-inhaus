...
const slides = [
  {
    image: 'https://ik.imagekit.io/ijsd2xvnc/Inhaus/public/hero1.jpg?tr=w-1600,f-webp,q-95',
  ...
  {
    image: 'https://ik.imagekit.io/ijsd2xvnc/Inhaus/public/bilal-mansuri-bWfP4W8Pb9c-unsplash.jpg?tr=w-1600,f-webp,q-95',
    alt: 'Modern kitchen design',
    subtitle: 'High-performance kitchens designed for how you cook, gather, and live.',
  },
  {
    image: 'https://ik.imagekit.io/ijsd2xvnc/Inhaus/public/hero3.jpg?tr=w-1600,f-webp,q-95',
    alt: 'Premium custom joinery',
    subtitle: 'Custom joinery and premium finishes, tailored to your space and style.',
  },
  {
    image: 'https://ik.imagekit.io/ijsd2xvnc/Inhaus/public/lisa-anna-varhNULWOBE-unsplash.jpg?tr=w-1600,f-webp,q-95',
      ...
      {slides.map((slide, idx) => (
        ...
        >
          ...
          <div className="hero__overlay">
            ...
            {/* ✅ Wrapper e classes únicas para o efeito cinema */}
